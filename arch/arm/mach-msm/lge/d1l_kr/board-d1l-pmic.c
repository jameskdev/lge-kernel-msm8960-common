...
#ifdef CONFIG_LGE_BROADCAST_TDMB/* add by heri.jang@lge.com for TDMB ANT selection*/	
...
PM8XXX_GPIO_OUTPUT(17, 0),					  /* DMB_ANT_SEL_INN */
	...
	//Used DMB PM8XXX_GPIO_OUTPUT(17,	    0),			 /* DISP 3.3 V Boost */
...
#ifdef CONFIG_MACH_LGE
static const unsigned int keymap_a[] = { LGE_KEY_MAP_A };
static const unsigned int keymap_b[] = { LGE_KEY_MAP_B };
...
static struct matrix_keymap_data keymap_data = {
	.keymap_size    = ARRAY_SIZE(keymap_a),
	.keymap         = keymap_a,
};
