...
int synaptics_t1320_power_on(int on)
{
	...
	if(!vreg_touch_3v){
		vreg_touch_3v = regulator_get(NULL, "8921_l17_touch");		/* +3V0_TOUCH */
		if (IS_ERR(vreg_touch_3v))
		{
			pr_err("%s: regulator get of vreg_touch_3v failed (%ld)\n", __func__, PTR_ERR(vreg_touch_3v));
	...
	if(!vreg_touch_1p8)
	{
		vreg_touch_1p8 = regulator_get(NULL, "8921_l29_touch");	/* +1V8_TOUCH_VIO */
